...
const Header = () => {
  ...
  return (
    <div className="bg-slate-100 border-b shadow-sm sticky top-0 z-50">
      <header className="flex justify-between items-center px-3 max-w-6xl mx-auto bg-slate-100">
        <div>
          <img
            onClick={() => navigate("/")}
            className="h-12 cursor-pointer w-36"
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRQU4AgCCZjITMi1Q-U2KrztDcnPoK4_rpwc5g&usqp=CAU"
            alt="RealSand"
          />
        </div>
        <div>
